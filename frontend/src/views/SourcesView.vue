    ...
    <v-dialog v-model="showSetSourceDialog" max-width="500">
      <v-card>
        ...
        <v-card-text>
          ...
          <v-text-field v-model="customSource" placeholder="自定义源 URL" clearable
...
const applySource = async () => {
  ...
  const extraSources = selectedExtraSource.value && selectedExtraSource.value !== sourceUrl ? [selectedExtraSource.value] : null
